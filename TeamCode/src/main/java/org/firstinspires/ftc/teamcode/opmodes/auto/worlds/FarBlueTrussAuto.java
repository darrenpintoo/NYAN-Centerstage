...
@Autonomous(name = "Far Blue Truss 2+2")
public class FarBlueTrussAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.pause(0.5);
        robot.intake.setRotationState(Intake.RotationStates.ROTATED);
        drive.gotoPoint(new Pose(-57, 57, 0), new MovementConstants(50, 25, -0.25));
        drive.gotoPoint(new Pose(-57, -35,   0), new MovementConstants(50, 10, -0.25));
