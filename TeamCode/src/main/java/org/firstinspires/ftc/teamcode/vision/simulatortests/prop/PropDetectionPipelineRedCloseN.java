...
public class PropDetectionPipelineRedCloseN implements VisionProcessor {
    ...
    public PropDetectionPipelineRedCloseN(Telemetry telemetry) {
        this.telemetry = telemetry;
    }

    public PropDetectionPipelineRedCloseN() {
